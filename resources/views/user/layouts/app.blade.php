    ...
    <div class="header">
        <div class="logo" style="background: #8fcc6d">
            <div class="custom-container">
                ...
                <a href="" class="custom-logo-link" rel="home" itemprop="url"><img height="150" src="/image/logo2.png" class="custom-logo" alt="logo-f" itemprop="logo" style="width: 60%;float: right;margin: 10px 0px;"></a>
            </div>
        </div>
